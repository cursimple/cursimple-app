...
import com.x500x.cursimple.core.plugin.runtime.DefaultWorkflowEngine
import com.x500x.cursimple.core.plugin.runtime.InstalledPluginBundle
import com.x500x.cursimple.core.plugin.runtime.PluginSyncInput
import com.x500x.cursimple.core.plugin.runtime.WorkflowEngine
...
class PluginManager(
    ...
    suspend fun ensureBundledPlugin(assetRoot: String) {
        ...
        try {
            val manifest = json.decodeFromString<com.x500x.cursimple.core.plugin.manifest.PluginManifest>(
